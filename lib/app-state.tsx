...
export function AppProvider({ children }: { children: React.ReactNode }) {
  ...
  useEffect(() => {
    ...
    pullChecks().catch(() => {});
    // The lines are the one thing here that could not be regenerated, so a
    // fresh device adopts them before it can be asked to write another.
    pullLines().catch(() => {});
