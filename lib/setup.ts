 ...
 * the source of truth for the running app; a failed push is reported, not
 * fatal.
 */
...
/**
 * After sign-in on a fresh install, adopt any setup already in Supabase so
 * phone and web stay one account with one config.
 */
